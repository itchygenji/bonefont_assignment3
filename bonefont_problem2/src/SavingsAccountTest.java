...
public class SavingsAccountTest {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 12; i++) {
			...
			System.out.printf("%s%15.2f%20.2f%n", monthOfYear[i], saver1.getSavingsBalance(), saver2.getSavingsBalance());//prints balance
			System.out.printf("________|||_________________|||_______________%n");
			
		}
		//set the annualInterestRate to 5%, calculate the next month’s interest
		SavingsAccount.modifyInterestRate (0.05);
		System.out.printf("%n%nInterest Rate is: %.2f%n", saver1.getAnnualInterestRate());
		System.out.printf("Initial Balance: %.2f%16.2f%n", saver1.getSavingsBalance(), saver2.getSavingsBalance());
		System.out.printf("%24s%16s%n", "Saver 1", "Saver 2");
		System.out.printf("%s%21s%20s%n______________________________________________%n", "Month", "Savings Balance", "Savings Balance");
		System.out.printf("%s%15.2f%20.2f%n", monthOfYear[12], saver1.getSavingsBalance(), saver2.getSavingsBalance());
		System.out.printf("________|||_________________|||_______________%n");
